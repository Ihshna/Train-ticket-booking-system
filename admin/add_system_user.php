...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($conn->query($query) === TRUE) {
        header("Location: dashboard.php?page=reports/system_user_report"); // Redirect to the report page
        exit();
    } else {
...
<head>
    ...
    <title><?= $updateMode ? "Edit System User" : "Add System User"; ?></title>
</head>
<body>
<div class="form-container">
<h2><?= $updateMode ? "Edit System User Details" : "Add New System User"; ?></h2>

<form action="add_system_user.php" method="POST">
    <?php if ($updateMode): ?>
    ...
    <div class="btn-container">
        <button type="submit" class="btn btn-submit"> <?= $updateMode ? "Update user" : "Add user"; ?></button>
