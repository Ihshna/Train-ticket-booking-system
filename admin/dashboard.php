...
<body>
    ...
    <nav>
        <ul>
            <li><a href="dashboard.php?page=../index">HOME</a></li>
            <li><a href="dashboard.php?page=../AboutUs">ABOUT US</a></li>
            
            <li class="dropdown">
                <a href="#">ADMINISTRATION ▼</a>
                <ul class="dropdown-menu">
                    <li><a href="dashboard.php?page=add_system_user">ADD NEW SYSTEM USER</a></li>
                    <li><a href="dashboard.php?page=add_customer">ADD NEW CUSTOMER</a></li>
                    <li><a href="dashboard.php?page=add_train">ADD NEW TRAIN</a></li>
                    <li><a href="dashboard.php?page=add_train_route">ADD NEW ROUTE</a></li>
                </ul>
            </li>
            <li class="dropdown">
                <a href="#">REPORTS ▼</a>
            ...
            <li><a href="dashboard.php?page=../user/registration">REGISTER</a></li>
            <li><a href="dashboard.php?page=password/change_password" onclick="showChangePasswordForm()">CHANGE PASSWORD</a></li>
